      ...
      <header className="flex flex-wrap items-end justify-between gap-4">
        <div>
          ...
          <p className="mt-2 max-w-xl text-ash">
            Upload or paste a transcript. It&apos;s checked against 13 known manipulation and communication
            patterns, with evidence quoted straight from the text — not a verdict on anyone, a place to look closer.
          </p>
        </div>
        {active && (
          <button
            onClick={() => setActive(null)}
            className="flex items-center gap-1.5 rounded-xl border border-night-hair px-3.5 py-2 text-sm text-ash transition hover:border-ember/40 hover:text-bone"
          >
